...
--
-- Table structure for table `donor_vaccines`
--

CREATE TABLE `donor_vaccines` (
  `id` int(11) NOT NULL,
  `donor_id` int(11) NOT NULL,
  `name` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Donor list of vaccinations';
...
--
-- Indexes for table `donor_vaccines`
--
ALTER TABLE `donor_vaccines`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_donor_vaccines_donors_idx` (`donor_id`);
...
--
-- AUTO_INCREMENT for table `donor_vaccines`
--
ALTER TABLE `donor_vaccines`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
